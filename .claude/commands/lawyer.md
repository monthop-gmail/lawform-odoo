...
## กฎเหล็ก: ห้ามข้ามการร่างเนื้อหา

**ทุกเอกสารที่มีเนื้อหาอิสระ ต้องร่างให้ครบก่อนส่งมอบ** ห้ามสร้างเอกสารแล้วปล่อยจุด `...` ไว้

เอกสารที่ต้องร่างเนื้อหาเสมอ:

| ฟอร์ม | ต้องร่าง | ตัวอย่าง |
|-------|---------|---------|
| **แบบ ๙** ใบแต่งทนาย | "ให้มีอำนาจ *..." | ยอมรับ ถอนฟ้อง ประนีประนอม อุทธรณ์ ฎีกา |
| **แบบ ๑** มอบอำนาจ | "ในเรื่อง ..." | ดำเนินคดีแพ่ง/อาญาต่อศาล... |
| **แบบ ๔** คำฟ้อง | เนื้อหาทั้งหมด (ข้อ ๑-๔) | ใช้ continuous_text (40 ก.) |
| **แบบ ๕** ท้ายฟ้องแพ่ง | คำขอ ๑. ๒. ๓. | ให้ชำระเงิน + ดอกเบี้ย + ค่าธรรมเนียม |
| **แบบ ๖** ท้ายฟ้องอาญา | บทมาตรา + คำขอ + ออกหมาย | ม.341 ฉ้อโกง, ขอให้ลงโทษ, ออกหมายจับ/เรียก |
| **แบบ ๑๑** คำให้การ | ยอมรับ/ปฏิเสธ + ข้อต่อสู้ | ปฏิเสธข้อ ๒ เพราะ... |
| **แบบ ๓๒** อุทธรณ์ | คัดค้านข้อใด + เหตุผล | ใช้ continuous_text (40 ก.) |
| **แบบ ๕๗** คำร้องปล่อยชั่วคราว | เหตุผล + หลักประกัน | จำเลยมีที่อยู่เป็นหลักแหล่ง ไม่หลบหนี |

วิธีร่าง:
1. `odoo_search_read` อ่าน body_html ของเอกสาร
2. หาจุด `...` ที่เป็นเนื้อหาอิสระ (ไม่ใช่ช่องลงชื่อ)
3. ร่างเนื้อหาแทนจุด
4. `odoo_write` เขียน body_html กลับ
5. สำหรับเนื้อหายาว (คำฟ้อง อุทธรณ์) ใช้ `legal.continuous.text` แทน
